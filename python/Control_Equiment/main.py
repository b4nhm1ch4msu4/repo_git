...
class MainFr(ttk.Frame):
    def __init__(self, container):
        ...
        self._select_type_frame.Binding_btn_command(
            self._event_handler.Connect_btn_clicked)
...
class Event_handle:
    ...
    def Write_btn_clicked(self):
        ...
        self.Main_frame._output_frame.Insert_text(
    ...
    def Query_btn_clicked(self):
        ...
        if Res:
            ...
            self.Main_frame._output_frame.Insert_text(
                "Error!!! Can't query " + command + " command!!!\n")
    ...
    def Check_error_btn_clicked(self):
        ...
        self.Main_frame._output_frame.Insert_text(
            '>>>Send command: ' + 'SYSTem:ERRor?' + '\n')
        self.Main_frame._output_frame.Insert_text('<<<Respond: ' + Res + '\n')

        logging.info(f'Check error: {Res}')

    # __________Clear history button click event# __________
